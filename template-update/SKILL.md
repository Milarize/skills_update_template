...
- **เช็คไขว้ด้วยเนื้อไฟล์จริง** — เพราะ baseline ข้างบนเชื่อ commit message
  ...
  message จะพิมพ์คำเตือนออกมา — ถ้าเจอคำเตือนนี้ ให้แจ้งผู้ใช้ชัดเจนว่า
  เวอร์ชันที่บอกไว้ (baseline จาก commit message) อาจไม่ตรงกับความเป็นจริง
  ก่อนจะแนะนำให้ merge ต่อ
